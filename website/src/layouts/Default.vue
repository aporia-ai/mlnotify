<template>
	<div class="layout text-black min-h-screen flex flex-col bg-grey-2 hover:layout-small font-heebo">
...
<style lang="scss">
.layout {
	background: url('../assets/bg/desktop/top-left.png') 0% 100px no-repeat,
		url('../assets/bg/desktop/bottom-left.png') bottom left no-repeat,
